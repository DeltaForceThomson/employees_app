...
class _UploadBrandsScreenState extends State<UploadBrandsScreen>
{
  ...
  TextEditingController optionInfoTextEditingController = TextEditingController();
  TextEditingController optionTitleTextEditingController = TextEditingController();

  bool uploading = false;
  String downloadUrlImage = "";
  String optionUniqueId = DateTime.now().millisecondsSinceEpoch.toString();
  ...
  saveBrandInfo()
  {
    FirebaseFirestore.instance
        ...
        .set(
        {
          "optionID": optionUniqueId,
          "employeeUID": sharedPreferences!.getString("uid"),
          "optionInfo": optionInfoTextEditingController.text.trim(),
          "optionTitle": optionTitleTextEditingController.text.trim(),
    ...
    setState(() {
      uploading = false;
      optionUniqueId = DateTime.now().millisecondsSinceEpoch.toString();
    });
  ...
  validateUploadForm() async
  {
    if(imgXFile != null)
    {
      if(optionInfoTextEditingController.text.isNotEmpty
          && optionTitleTextEditingController.text.isNotEmpty)
      {
        setState(() {
          uploading = true;
        });
        ...
        fStorage.Reference storageRef = fStorage.FirebaseStorage.instance
            .ref()
            .child("employeeOptionImages").child(fileName);
      ...
      {
        Fluttertoast.showToast(msg: "Please write option info and option title.");
      }
    }
    else
    {
        ...
        children: [
          ...
          ListTile(
            ...
            title: SizedBox(
              width: 250,
              child: TextField(
                controller: optionInfoTextEditingController,
                decoration: const InputDecoration(
                  hintText: "option info",
          ...
          ListTile(
            ...
            title: SizedBox(
              width: 250,
              child: TextField(
                controller: optionTitleTextEditingController,
                decoration: const InputDecoration(
